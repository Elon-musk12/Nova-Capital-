  ...
  return (
    <main>
      <nav className="nav">
        ...
        <div className="navActions"><a className="login" href="/login">Login</a><a className="goldBtn" href="/login">Open Account</a></div>
      </nav>
      ...
      <section id="home" className="hero">
        <div className="heroText">
          ...
          <div className="heroButtons"><Link className="goldBtn large" href="/login">Start Investing →</Link><a className="outlineBtn large" href="#investments">Explore Our Platform</a></div>
        </div>
